...
function GameStatus(props) {
  ...
  function renderGameStatus() {
    ...
    if ((hiddenWord.join("") === word) && (totalGuesses > 0)) {
      ...
      return (
        <div>
          <h2>There's still time!<br/>
          Don't get hung up on the wrong answer!</h2>
        </div>
      );
      ...
      return (
        <div>
          <h2>Don't let that wrong letter make you feel hung out to dry!</h2>
        </div>
      );
      ...
      return (
        <div>
          <h2>You're hanging on by a thread!<br/>
          1 wrong guess remaining</h2>
        </div>
      );
